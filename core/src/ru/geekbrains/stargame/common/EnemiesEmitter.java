...
public class EnemiesEmitter {//параметры вражеских караблей и их пуль
	...
	public void generateEnemies(float delta, int frags){
		...
		if(generateTimer >= generateInterval){
			...
			enemy.pos.x = Rnd.nextFloat(worldBounds.getLeft() + enemy.getHalfWidth(), worldBounds.getRight() - enemy.getHalfWidth());//случайное появление кораблей относительно Y
